...
registerCheck({
  ...
  titleHe: "ודא שמכשירים ללא מדיניות תאימות מסומנים כ-'לא תואמים'",
  descriptionHe: "כברירת מחדל, Intune מתייחס למכשירים ללא policy כ'תואמים'. יש לשנות הגדרה זו כך שמכשיר שאין לו policy מוקצית ייחשב כ'לא תואם' ויחסם מגישה למשאבים.",
  category: 'Intune / Device Management', domain: 'defender', severity: 'high',
  benchmarkRef: 'CIS M365 v6.0.1 - 4.1', framework: 'cis_m365',
  expectedState: 'Intune compliance settings: Mark devices with no compliance policy as Not compliant',
  remediationHe: 'Microsoft Intune admin center (intune.microsoft.com) → Devices → Compliance → Compliance policy settings → "Mark devices with no compliance policy as" → שנה ל-"Not compliant" → Save.',
  ...
  graphApiEndpoint: '/deviceManagement/deviceCompliancePolicySettingStateSummaries',
