...
registerCheck({
  ...
  category: 'Power BI / Fabric', domain: 'power_bi', severity: 'high',
...
registerCheck({
  ...
  category: 'Power BI / Fabric', domain: 'power_bi', severity: 'critical',
...
registerCheck({
  ...
  category: 'Power BI / Fabric', domain: 'power_bi', severity: 'medium',
